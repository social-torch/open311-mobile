...
class UpdateReportLocPage extends Page {
  ...
  Widget build(BuildContext context) {
    return const UpdateReportLocBody();
  }
}

class UpdateReportLocBody extends StatefulWidget {
  const UpdateReportLocBody();

  @override
  State<StatefulWidget> createState() => UpdateReportLocBodyState();
}

class UpdateReportLocBodyState extends State<UpdateReportLocBody> {
  UpdateReportLocBodyState();
